            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body m-3">
                        <form id="dataForm" method="POST" action="<?= base_url('categoriasProducto') ?>">
                            <?= csrf_field() ?>
                            <input class="form-control" type="hidden" id="id" name="id" value="0" />
                            <div class="mb-3">
                                <label class="form-label">Nombre</label>
                                <input class="form-control" type="text" id="nombre" name="nombre" placeholder="Ingrese el nombre de la categoria" />
                            </div>
                            <div class="mb-3">
        ...
        <div class="modal fade" id="modalDeleteForm" tabindex="-1" role="dialog" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered modal-sm" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body m-3">
                        <form id="deleteForm" method="POST" action="<?= base_url('delete-categoriaProducto') ?>">
                            <?= csrf_field() ?>
...
<script>
    $(document).ready(function() {
        $('.sidebar-categorias-producto').addClass('active');
        table = $('#table').DataTable({
            ...
            order: [],
            ajax: {
                url: "<?= base_url('get-categoriasProducto') ?>"
            },
            columnDefs: [{
                targets: [-1],
                orderable: false,
...
<script>
    ...
    const obtener = (id) => {
        ...
        fetch(`<?= base_url('get-categoriaProducto') ?>/${id}`, {
            method: "get",
            headers: {
            ...
            document.getElementById('id').value = categoriaProducto.id;
            document.getElementById('nombre').value = categoriaProducto.nombre;
            document.getElementById("activa").checked = categoriaProducto.activa == "1" ? true : false;
